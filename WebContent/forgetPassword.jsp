		...
		<div class="uiv2-content-wrapper">
			...
			<div class="uiv2-content-wrapper">
				...
				<div class="uiv2-padding-vertical-60">
					...
					<form action="ForgetPassword.action" method="post" name="contact_form">
						...
						<div class="uiv2-login-block-left">
							...
							<p>&nbsp;</p>
							<font color="red"><s:property value="successMsg"/></font>
							...
							<div class="uiv2-mar-t-10 uiv2-login-button-block">
								...
								<input type="submit" value="Reset Password" id="id_page_login_btn" />
