...
Generate Receipt Form<br/>
<form action="GenerateReceiptAction.action" name="AcceptRejectPendingOrderForm">
...
<table border="1" align="center">
		...
		<%
			...
			%>
				<tr>
					<th><input type="button" name="" value="Print" onclick="printInvoice('<%=key[0]%>')"/></th>
					
					<td><span style="word-wrap:break-word;"><b>Selected Slot : </b><%=key[2] %></span></td>
