...
<script type="text/javascript">
	...
	function getProductList(){
		...
		$.get(
			    ...
			    function(data) {
			    	var header = "<tr><th>Product Name</th>	<th>Product Brand Name</th><th>Product Image</th><th>Product Size</th><th>Edit</th></tr>";
			    	if(data.trim() != "null" && data.trim() != null && data.trim() != 'null'){
				    	...
				    	if(typeof arr !== undefined &&arr.length!=0){
					    	for(var i = 0; i < arr.length; i++){
					    		...
					    		str = str + "<tr><td>"+arr1[0]+"</td><td>"+arr1[1]+"</td><td><img src='"+arr1[3]+"' width='80' height='80'/></td><td>"+arr1[2]+"</td><td><a href='EditProductForm.action?productId="+arr1[4]+"&rootCategory="+val+"&subRootCategory="+val1+"&childCategory="+val2+"' >edit</a></td></tr>";
					    	}
				    	}
				    	else{
