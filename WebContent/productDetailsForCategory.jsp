						...
						<div class="uiv2-product-info-wrapper">
							...
							<div class="uiv2-product-detail-content">
								...
								<div class="uiv2-product-value">
									...
									Rs. <strike><%=actualPrice %></strike> - 
									<%} %>
									Rs.<%=offerPrice %><br/>

										<select name='<%="dropDown"+productId%>' id='<%="dropDown"+productId%>'>
										...
										<li name="widget_40009485">
											...
											<div class="uiv2-add-to-basket">
												...
												<div class="uiv2-rate-count-btn"><span class="uiv2-qty-label">Qty</span>
													...
													<input value="1" id='<%="quantityShow"+productId%>' onBlur="quantityAdd('<%=productId %>')" type="text">

													<input value="1" id='<%="quantity"+productId%>' type="hidden">

												</div>

												<a class="uiv2-add-button a2c" href="javascript:void(0)" onClick="javascript:addToCart('<%=productId%>')" > ADD<span class="icon icon-basket-gray"></span></a>
