			...
			<div class="uiv2-content-wrapper">
				...
				<div class="uiv2-content-wrapper">
					...
					<div class="uiv2-shopping-list-wrapper">
						...
						<%
							Map<String, ArrayList<String>> values = (Map<String, ArrayList<String>>) request
							...
							String startIndexVal = request.getParameter("startIndex") != null ? request
									...
									.getAttribute("startIndexWishList");
							int startIndex = (Integer.parseInt(startIndexVal) - 1)
									* displaySize;
							/* //int startIndex=1;
							 ...
							 */
							int count = Integer.parseInt(request.getAttribute("productCount").toString());
						...
						<input type="hidden" name="rootCategory" id="rootCategory"
							...
							id="type" value="products"> <input type="hidden"
						...
						<input type="hidden" name="categoryName" id="categoryName"
							...
							name="startIndex" id="startIndex" value="<%=startIndexShow%>">
							 ...
							 --%>
								<div class="pagination">
									...
									<ul class="pages">
										...
										<li><a
											href="ViewProductsPagination.action?categoryName=<%=categoryName%>&startIndex=<%=x%>&categoryId=<%=categoryId%>&subRootCategory=<%=subRootCategory%>&rootCategory=<%=rootCategory%>"
											class="selected"><%=x%></a>
										</li>&nbsp;
										...
										<li><a
											href="ViewProductsPagination.action?categoryName=<%=categoryName%>&startIndex=<%=x%>&categoryId=<%=categoryId%>&subRootCategory=<%=subRootCategory%>&rootCategory=<%=rootCategory%>"><%=x%></a>
										</li>&nbsp;
							...
							<div class="paginationArea">
								...
								<div class="pagination">
									...
									<ul class="pages">
										...
										<li><a
											href="ViewProductsPagination.action?categoryName=<%=categoryName%>&startIndex=<%=y%>&categoryId=<%=categoryId%>&subRootCategory=<%=subRootCategory%>&rootCategory=<%=rootCategory%>"
											class="selected"><%=y%></a>
										</li> &nbsp;
										...
										<li><a
											href="ViewProductsPagination.action?categoryName=<%=categoryName%>&startIndex=<%=y%>&categoryId=<%=categoryId%>&subRootCategory=<%=subRootCategory%>&rootCategory=<%=rootCategory%>"><%=y%></a>
										</li>&nbsp;
