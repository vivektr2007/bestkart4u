...
<title><s:property value="getText('label.header')" /></title>
...
<script type="text/javascript">
	...
	function regiserAction(){
		...
		if(passwordStrength == 'Weak' || passwordStrength == 'Too short'){
			...
			$('#register_success p').text("Password can't be Too short or Weak.");
			...
			$('#register_success p').text("Password and Confirm-Password must be same.");
			$('#register_success').css('display','block');
		...
		<div class="uiv2-content-wrapper">
			<div class="uiv2-content-wrapper">
				<div class="uiv2-padding-vertical-60" style=" padding:60px 30px;">
					<form name="registerform" method="POST" action="RegisterAction.action" class="uiv2-form" id="id_register_form">
						<fieldset>
						<div class="legend">Login Details</div>
						<div class="uiv2-form-row"> <span class="uiv2-form-label">Email Address <span class="uiv2-field-required">*</span> </span>
							<div class="uiv2-form-input"> <span>
								<input id="id_email" onBlur="checkEmail()" required="required" type="email" name="emailId" autocomplete="off" value='<s:property value="regBean.getEmailId()"/>' size="20" />
								</span> <span id="emailError" class='error' style='color: #BD4247;'></span> </div>
						</div>
						<div class="uiv2-form-row"> <span class="uiv2-form-label">Mobile Number <span class="uiv2-field-required">*</span> </span>
							<div class="uiv2-form-input"> <span class="uiv2-input-prepend">+91</span> <span class="uiv2-input-with-prepend">
								<input name="mobileNo" autocomplete="off" required="required" maxlength="10" value='<s:property value="regBean.getMobileNo()"/>'  onkeypress="return isNumberKey(event)" type="text" id="id_mobile_no" size="15" />
								</span> </div>
						</div>
						<div class="uiv2-form-row"> <span class="uiv2-form-label">Password <span class="uiv2-field-required">*</span> </span>
							<div class="uiv2-form-input"> <span>
								<input id="password" required="required" autocomplete="off" maxlength="30" type="password" name="password" size="20" />
								<span id="result"></span> </span> <span id="result"></span>
								<!-- <div class="uiv2-help-text">Minimum 6 Characters</div> -->
							</div>
						</div>
						<div class="uiv2-form-row"> <span class="uiv2-form-label">Confirm Password <span class="uiv2-field-required">*</span> </span>
							<div class="uiv2-form-input"> <span>
								<input id="id_password2" maxlength="30" required="required" type="password" name="confirmPass" size="20" />
								</span> <span id="passError" class='error' style='color: #BD4247;'></span> </div>
						</div>
						</fieldset>
						<fieldset>
						<div class="legend">Personal Details</div>
						<%-- <div class="uiv2-form-row"> <span class="uiv2-form-label">Salutation <span class="uiv2-field-required">*</span> </span>
							<div class="uiv2-form-input"> <span class="uiv2-mar-t-8">
								<select style=" width:212px;" id="salutation" required="required"  name="salutaion">
						...
						<div class="uiv2-form-row"> <span class="uiv2-form-label">First Name <span class="uiv2-field-required">*</span> </span>
							<div class="uiv2-form-input"> <span>
								<input id="id_first_name" value='<s:property value="regBean.getFirstName()"/>'  required="required" type="text" name="firstName" size="30" />
								</span> </div>
						</div>
						<div class="uiv2-form-row"> <span class="uiv2-form-label">Last Name <span class="uiv2-field-required">*</span> </span>
							<div class="uiv2-form-input"> <span>
								<input id="id_last_name" value='<s:property value="regBean.getLastName()"/>'  required="required" type="text" name="lastName" size="30" />
								</span> </div>
						</div>
						<%-- <div class="uiv2-form-row"> <span class="uiv2-form-label">Date Of Birth <span class="uiv2-field-required">*</span> </span>
						...
						<%-- <div class="uiv2-form-row"> <span class="uiv2-form-label">Telephone Number</span>
							<div class="uiv2-form-input"> <span>
						...
						<div class="uiv2-form-row"> <span class="uiv2-form-label">House no &amp; Details <span class="uiv2-field-required">*</span> </span>
							<div class="uiv2-form-input"> <span>
								<input id="id_address1" value='<s:property value="regBean.getHouseDetail()"/>'  required="required" type="text" name="houseDetail" size="30" />
								</span> </div>
						</div>
						<div class="uiv2-form-row"> <span class="uiv2-form-label">Street Details</span>
							<div class="uiv2-form-input"> <span>
								<input id="id_address2" value='<s:property value="regBean.getStreetDetail()"/>'  type="text" name="streetDetail" size="30" />
								</span> </div>
						</div>
						<div class="uiv2-form-row"> <span class="uiv2-form-label">Area <span class="uiv2-field-required">*</span> </span>
							<div class="uiv2-form-input"> <span><span role="status" aria-live="polite" class="ui-helper-hidden-accessible"></span>
						...
						<div class="uiv2-form-row"> <span class="uiv2-form-label">Residential Complex</span>
							<div class="uiv2-form-input"> <span>
								<input id="id_residential_complex" value='<s:property value="regBean.getResidentComplex()"/>'  type="text" name="residentComplex" size="30" />
								</span> </div>
						</div>
						<div class="uiv2-form-row"> <span class="uiv2-form-label">Landmark</span>
							<div class="uiv2-form-input"> <span>
								<input id="id_landmark" value='<s:property value="regBean.getLandmark()"/>'  type="text" name="landmark" size="30" />
								</span> </div>
						</div>
						<div class="uiv2-form-row"> <span class="uiv2-form-label">City <span class="uiv2-field-required">*</span> </span>
							<div class="uiv2-form-input"> <span class="uiv2-push-left uiv2-mar-t-8">
								<select style=" width:212px;" id="city" name="city" required>
									<option value="">Select</option>
									<option value="Mr.">Dwarka(New Delhi)</option>
								</select>
								</span> <span class="uiv2-push-left">
								<script type="text/javascript"></script>
								<div class="uiv2-small-pop-up" id="small_popup_pin_info" style="display: none;"> <span class="uiv2-pop-up-pointer"></span>
						...
						<%-- <div class="uiv2-form-row uiv2-captcha-container uiv2-terms"> <span class="uiv2-form-label" style=" width:100%;">Type the characters shown in the box<span class="uiv2-field-required">*</span> </span>
							<div class="uiv2-form-input" id="captcha"><span> <img alt="captcha" id="imgcaptcha" src="CaptchaAction.action" onClick="reloadCaptcha()">
								<!-- <img src="http://localhost:8989/RetailShop/CaptchaServlet"/>

								 -->
								</span>
								<input type="button" onClick="reloadCaptcha()" value=""/>
							</div>
						</div> --%>
						<%-- <div class="uiv2-row-border">
							<input id="id_captcha_1" value="" type="text" required="required" name="captcha_1" size="6" />
							<br/>
							<span class='error' style='color: #BD4247;'>
						...
						<div class="uiv2-para-text uiv2-clear uiv2-terms-container uiv2-terms" style="padding-top: 16px; margin-left: 8px">
							...
							<p class="uiv2-input-desc">I accept the <a href="terms-and-conditions.jsp" target="_blank" title="Please read the Terms and Conditions">Terms and Conditions</a><span class="uiv2-field-required">*</span></p>
							<br />
							<br />
						...
						<div class="uiv2-form-button-wrapper uiv2-mar-t-10"> 
							<span class="uiv2-push-left"> 
								<a onClick="regiserAction()" href="javascript:void();" class="uiv2-checkout-button">REGISTER</a> 
							</span> 
							<span class="uiv2-push-left"> <a href="index.jsp" class="uiv2-cancel-button">
							<p>cancel</p>
							</a> </span> </div>
					</form>
				
				<div class="register-fb">
					<!--<div class="fb_login_block">
						<h1>Register using Facebook</h1>
						<a onClick="checkLoginState()" class="login-facebook" href="javascript:void():">Register</a>
					</div>-->
					<div class="fb-register"><a onClick="checkLoginState()" class="login-facebook" href="javascript:void():">&nbsp;</a></div>
				</div></div>
			</div>
		</div>
	</div>
		...
		<div class="payment_content_sub">
			<div class="payment_content1">
				<div class="feedback_block">
					...
					<p>Captcha code entered is invalied.</p>
				</div>
				<a class="popup-close" href="javascript:void():" id="register_cancel">&nbsp;</a> </div>
		</div>
	</div>
...
<script type="text/javascript">
	var data = '<%=request.getAttribute("errorMsg")%>';
	if(data != null && data != '' && data != 'null' && data != 'NULL'){
		$('#register_success p').text(data);
		$('#register_success').css('display','block');
	}
	var registerErrorMsg = '<%=request.getAttribute("registerErrorMsg")%>';
	if(registerErrorMsg != null && registerErrorMsg != '' && registerErrorMsg != 'null' && registerErrorMsg != 'NULL'){
		$('#register_success p').text(registerErrorMsg);
		$('#register_success').css('display','block');
	}
</script>