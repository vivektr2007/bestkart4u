...
<script type="text/javascript">
	...
	function editSubCategoryFunc(){
		...
		var txt2 = $("#subCategoryId option:selected").val();
	...
	function fillTextField(){
		...
		var txt = $("#subCategoryId option:selected").text();
		if(txt == '--select--'){
			$("#categoryText").val("");
...
Edit Sub Category Form<br/>
<form action="EditSubCategory.action" name="editSubCategory" method="post">
	<table border="1" align="center">
			...
			<tr>
				<td>Sub Category : </td>
				<td><select name="subCategoryId" id="subCategoryId" onchange="fillTextField()">
