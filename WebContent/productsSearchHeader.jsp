...
<script type="text/javascript">
	function searchForBrand() {
		...
		document.searchForm.action = "ViewProductsForBrand.action";
		document.getElementById("searchStartIndex").value='1'
	...
	function searchForBrandPagination(value){
		...
		document.searchForm.action = "SearchProductActionHeader.action";
		document.searchForm.submit();
	}
				...
				<div class="uiv2-content-wrapper">
					...
					<div class="uiv2-shopping-list-wrapper">
						...
						<input type="hidden" name="rootCategory" id="rootCategory"
							...
							id="type" value="productsForSearchHeader"> <input type="hidden"
