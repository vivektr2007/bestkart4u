	...
	function getCookies() {
		...
		if (c != "" || c != '') {
			...
			if(parseInt(itemCount) == 0){
				...
				$("#checkOutAnchor").hide();
				$("#myBasket")
				.html('<div class="uiv2-items-content-wrapper empty_cart"><div class="uiv2-items-content"><span><a href="javascript:void();"></a></span>'+
		...
		if (c != "" || c != '') {
			...
			for ( var i = 0; i < allValCookie.length; i++) {
				...
				val = val
						...
						'<input type="text" readonly="readonly" name="quantity5" value="'+allVal[3]+'" class="qty">'
						+
			...
			$("#finalTotal").text("Rs. " + parseFloat(allTotal));
...
<body onLoad="getCookies();showCart()">
				...
				<div class="uiv2-content-wrapper">
					...
					<div class="uiv2-basket-container">
						...
						<div class="uiv2-title-basketwrap">
							...
							<h4>
								Your Basket (<span id="noItems">0</span> items)
							</h4>
					...
					<div id="mainEligiblePromo" class="uiv2-viewaviled-button-wrap"> <a class="uiv2-viewavilable-button" href="javascript:void();" id="popup_available_promos" onClick="show_promo('popup_available_promos');"> <span class="icon icon-promo-orange"></span>
						...
						<div class="uiv2-basket">
							...
							<div id="showCart" class="uiv2-yourbasketitems-gridlist"></div>
						...
						<section class="uiv2-shoppingcartblock">
							...
							<div class="uiv2-enter-your-evoucher-left">
								...
								<div style="margin-top: 240px; float: left;">
									<a href="index.jsp" class="uiv2-continue-shopping-button">CONTINUE
										SHOPPING</a>
								</div>
								...
								<div class="uiv2-deliver-charges-wrapper">
									...
									<div class="uiv2-deliver-charges-totalamount">
										...
										<div class="uiv2-subtotal-listblock">
											...
											<b>TOTAL <span id="finalTotal"> </span> </b>
										</div>

										<div class="uiv2-yousaved-wrap">
											<span>You saved!</span><span id="totalSaving"> </span>
										</div>

									</div>

									<div class="uiv2-avial-freedelivery ">
										<span class="icon icon-delivery-van"></span>
										<p>
											<span id="freeDeliveryNote"> Shop for <span
												class="WebRupee">Rs.</span> 299 or more to avail Free Delivery!
											</span>
										</p>
									</div>
									<a id="checkOutAnchor" href="CheckOutAction.action"
										class="uiv2-checkout-button">
										<p id="checkOutAnchorP">CHECKOUT</p> <span
										class="icon icon-navigating-right"></span> </a>
								</div>
							</div>
