...
<%!
	private static final Logger logger = Logger.getLogger("productListInner.jsp");
%>
<nav id="uiv2-main-menu">
								...
								<div class="uiv2-dropdown-column">
										...
										<%	while(rs1.next()){
											...
											String subCategoryName = rs1.getString("sub_category_name"); 
											 %>	
										<%-- <li><a href="javascript:void();"><%="ppppp"+subCategoryName %></a></li>
				...
				<a href="complete-shop.jsp" class="uiv2-view-complete-link">VIEW COMPLETE SHOP</a></nav>