function validateForm(){
	var x=document.forms["contact_bestkart"]["eq_name"].value;
	...
	var x=document.forms["contact_bestkart"]["eq_email"].value;

	
	if (x==null || x=="Email Address"){
  		document.getElementById("eq_email").style.background="#ed867d";
		document.getElementById("eq_email").style.border="1px solid #c51c0e"
		return false;
  	}
	
	var x=document.forms["contact_bestkart"]["eq_contact"].value;
	...
	var x=document.forms["contact_bestkart"]["eq_query"].value;
	if (x==null || x=="Query"){
